...
def get_euroc_x_bovw_binocular_depth_config(dataset_root, _stride):
    config = get_euroc_x_config(dataset_root, None)
    config['exp_name'] = 'euroc_x_bovw_binocular_depth'
    return config
...
def get_kitti_4_6_T_mixed_config(dataset_root, stride):
    config = get_kitti_4_6_mixed_config(dataset_root, stride)
    config['exp_name'] = 'kitti_4/6_T_mixed'
    return config
