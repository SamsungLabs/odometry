...
class Evaluate(keras.callbacks.Callback):
    ...
    def _maybe_save_trajectory(self, prediction_id, subset, trajectory_id, predictions):
    ...
    def _evaluate(self, generator, gt, subset, prediction_id):
        ...
        for i, (trajectory_id, indices) in enumerate(tqdm.tqdm(gt_by_trajectory,
            ...
            self._maybe_save_trajectory(prediction_id, subset, trajectory_id, predictions.iloc[indices])
