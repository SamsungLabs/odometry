...
class ResNet50Trainer(BaseTrainer):
    ...
    def __init__(self,
        ...
        super(ResNet50Trainer, self).__init__(dataset_root=dataset_root,
    ...
    def train(self):
        ...
        construct_graph_fn = functools.partial(construct_resnet50_model)
...
if __name__ == '__main__':
    ...
    trainer = ResNet50Trainer(dataset_root=args.dataset_root,
