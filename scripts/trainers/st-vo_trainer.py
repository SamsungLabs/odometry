...
from odometry.models import ModelFactory, construct_st_vo_model
...
class StVoTrainer(BaseTrainer):
    ...
    def __init__(self,
        ...
        super(StVoTrainer, self).__init__(dataset_root=dataset_root,
    ...
    def train(self):
        ...
        construct_graph_fn = functools.partial(construct_st_vo_model)
...
if __name__ == '__main__':
    ...
    trainer = StVoTrainer(dataset_root=args.dataset_root,
